...
public class P2UIManageScript : MonoBehaviour
{
    ...
    void Start()
    {
        tankDataScript = tank2.GetComponent<TankDataScript>();
        tankLogicScript = tank2.GetComponent<TankLogicScript>();
    }
    ...
    private void RenderNormalPage(bool condition = true) //注释同P1UI
    {
        if (condition)
        {
    ...
    private void RenderInformationPage(bool condition = true)
    {
        if (condition)
        {
